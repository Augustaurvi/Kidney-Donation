<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reciver.aspx.cs" Inherits="reciver" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <title>Reciver Registration</title>
...
<form id="Form1" runat="server">
      ...
      <div class="heading_container">
               <h1 style="font-size: larger; font-weight: bold; font-style: normal; font-variant: inherit; text-transform: capitalize; ; text-align: center; text-indent: inherit">Kidney Reciver Registration Form</h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
            <div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Reciever Name Is Required." ControlToValidate="dname" ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:TextBox ID="dname" runat="server" CssClass="form-control" placeholder="Reciever Name"></asp:TextBox>
              </div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn btn-dark" 
              ...
              <div>
                       <br /><asp:Label ID="Label1" runat="server" Text="Label" Visible="false" Font-Bold="True" ForeColor="Green"> <i class=" fa fa-heart">
                       </i></asp:Label>
        ...
        <div class="col-md-6">
          ...
          <asp:Image ID="Image1" runat="server" ImageUrl="images/rec1.jpg" CssClass="img-box img-fluid"></asp:Image>

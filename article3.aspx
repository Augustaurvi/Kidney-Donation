<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article3.aspx.cs" Inherits="article3" %>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section id="article">
        <div class="container wow fadeInUp " data-wow-delay="0.1s">
            <img class="head-img img-responsive" src="images/news-image3.jpg" alt="">
            <div class="details-container">
                <div class="title"><h3> Living Kidney Donation </h3></div>
               ...
               Living kidney donation is when a healthy person donates one of their two kidneys while they are alive. Getting a kidney from a living donor has lots of benefits for the person who needs a transplant, called the recipient. If you are interested in donating a kidney, you will work with a transplant center at a hospital. The transplant center will make sure you are healthy enough to donate, do the surgery, and help you recover.
                ...
                <p>There are a few common requirements for people who are interested in living donation. You must be at least 18 years old. Some transplant centers require a donor to be 21 or even a little older. There are some medical conditions that could prevent you from being a living donor, including having uncontrolled high blood pressure, diabetes, or cancer.
                </p>
                <p>  Each transplant center has slightly different requirements, so you should always let the transplant center decide who would be a good donor. If you are approved as a living donor at one transplant center, you may be able to get evaluated at other centers who have different requirements.</p>

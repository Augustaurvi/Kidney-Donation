        ...
        if (apic.HasFile)
        {
           ...
           // if (ext == ".jpg" && ext == ".JPG" || ext == ".jpeg" && ext == ".JPEG" || ext == ".PNG" && ext == ".png")
            //{
                ...
                String query = "INSERT INTO donations(userid,dname,gender,mobile,age,email,bloodgp,aadharno,apic,mdissue) VALUES(@userid,@dname,@gender,@mobile,@age,@email,@bloodgp,@aadharno,@apic,@mdissue)";
               ...
               // Label1.Text = "please upload adhara card Image in JPG, JPEG or PNG Format.";
                ...
                Label2.Visible = true;
                Label2.Text = " Thanks For beging Part Of Saving Lifes!!";

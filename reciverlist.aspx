<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reciverlist.aspx.cs" Inherits="reciverlist" %>
...
<form id="Form1" runat="server">
      ...
      <div class="heading_container">
        <h1 style="font-size: larger; font-weight: bold; font-style: normal; font-variant: inherit;  text-align: center; text-indent: inherit">
            Reciver&nbsp; List</h1>
      </div>
            <div class="row">
        <div class="col-md-6">
          ...
          <div style="text-align: center; text-indent: inherit">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="SqlDataSource1" Width="1243px" 
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField HeaderText="apic" SortExpression="apic">
                          <EditItemTemplate>
                              <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("apic") %>'></asp:TextBox>
                          </EditItemTemplate>
                          <ItemTemplate>
                              <asp:Image ID="Image1" runat="server" Height="106px" 
                                  ImageUrl='<%# Eval("apic") %>' Width="184px" />
                          </ItemTemplate>
                      </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [reciever]">
                </asp:SqlDataSource>
          </div>
